  ...
  OneButton memButton1(A4, true);
  OneButton memButton2(A3, true);
  OneButton memButton3(A2, true); 
  OneButton memButton4(A1, true);
  OneButton memButton5(A0, true);

  OneButton volumeRotaryButton(6, true);
  OneButton tuneRotaryButton(7, true);

  // pin 0,1,2,4 and 7 are interrupt pins on the micro.
  // 2 and 3 are already used by the I2C so we are using pin 0 and 1
  Encoder volumeRotaryEncoder(1, 4);
  Encoder tuneRotaryEncoder(0, 5);
  
  int ledPin_memButton1 = 8;
  int ledPin_memButton2 = 9;
  int ledPin_memButton3 = 10;
  int ledPin_memButton4 = 11;
  int ledPin_memButton5 = 12;
